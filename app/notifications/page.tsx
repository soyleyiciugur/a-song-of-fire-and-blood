...
function Notifications() {
  ...
  useEffect(() => { if (activeNotification) setLedgerTab("personal"); }, [activeNotification?.id]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return <main className={styles.page}>
    ...
    <nav className={styles.ledgerTabs} role="tablist" aria-label="Rookery ledgers">
      <button type="button" role="tab" aria-selected={ledgerTab === "personal"} disabled={!userId} onClick={() => setLedgerTab("personal")}>Personal Ravens</button>
      <button type="button" role="tab" aria-selected={ledgerTab === "realm"} onClick={() => setLedgerTab("realm")}>Across the Realm</button>
    </nav>

    {ledgerTab === "personal" && userId && <div className={styles.ledgerPanel} role="tabpanel"><section className={styles.personalLedger} aria-label="Personal raven notifications"><div className={styles.sectionHeading}><span>Personal ravens</span><small>Mara & Aldren</small></div>
    ...
    {ledgerTab === "realm" && <div className={styles.ledgerPanel} role="tabpanel"><section className={styles.communityLedger} aria-label="Community activity">
