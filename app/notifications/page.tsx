...
function Notifications() {
  ...
  return <main className={styles.page}>
    <div className={styles.topRow}><Link href="/" className={styles.back}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="m10 6-6 6 6 6M4 12h16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>Back to Home</Link>{userId && <Link className={styles.settingsLink} href="/settings#notifications" aria-label="Raven settings"><svg className={styles.settingsIcon} viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 8.25a3.75 3.75 0 1 0 0 7.5 3.75 3.75 0 0 0 0-7.5Z"/><path d="M19.14 12.94a7.8 7.8 0 0 0 .06-.94 7.8 7.8 0 0 0-.06-.94l2.03-1.59-1.92-3.32-2.39.96a7.22 7.22 0 0 0-1.63-.94L14.87 3.6h-3.84l-.36 2.57a7.22 7.22 0 0 0-1.63.94l-2.39-.96-1.92 3.32 2.03 1.59A7.8 7.8 0 0 0 6.7 12c0 .32.02.63.06.94l-2.03 1.59 1.92 3.32 2.39-.96c.5.39 1.04.7 1.63.94l.36 2.57h3.84l.36-2.57a7.22 7.22 0 0 0 1.63-.94l2.39.96 1.92-3.32-2.03-1.59Z"/></svg><span className={styles.settingsText}>Raven settings</span></Link>}</div>
