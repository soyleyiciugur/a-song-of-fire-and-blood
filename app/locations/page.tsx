...
export default function LocationsPage() {
  ...
  return <main className={styles.page}><div className={styles.container}><p className={styles.eyebrow}>The Known World</p><h1 className="realm-page-title">Locations</h1><p className={styles.lead}>Seats, strongholds, and places remembered by the map.</p><nav className={`${styles.tabs} realm-section-tabs`}><Link href="/map">Map</Link><Link aria-current="page" className={styles.activeTab} href="/locations">Locations</Link></nav>
