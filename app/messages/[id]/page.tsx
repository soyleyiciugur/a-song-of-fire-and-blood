  ...
  return (
    <main className={styles.page}>
      <div className={styles.shell}>
        ...
        <RavenConversation key={id} conversationId={id} conversation={data.selected.conversation} userId={data.userId} partner={data.selected.partner} members={data.selected.members} memberships={data.selected.memberships} initialMessages={data.messages} blockedByMe={data.blockedByMe} blockedByThem={data.blockedByThem} />
      </div>
    </main>
  );
}
