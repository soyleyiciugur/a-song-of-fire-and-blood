...
export const houses: House[] = [
  ...
  },
  {
    id: "whent",
    name: "House Whent",
    words: "Wisdom and Severity",
    seat: "Harrenhal",
    sigilSrc: "/images/houses/whent.webp",
    color: "#FFD93D",
    description:
      "A crownlands house best known here through Curtass Whent, whose long shadow stretches from the Kingsguard to the woods south of King's Landing.",
  },
  {
    id: "lannister",
