...
export const quotes: CharacterQuote[] = [
  {
    text: "I trusted you. I did not love you. Love is for mothers and fools. I trusted you. (to Visenor)",
  ...
  {
    text: "Did I not tell you to stop questioning things? (to Gaelor)",
  ...
  {
    text: "You truly were a loyal Hand... until you weren't. (to Derrin)",
    speakerId: "jacaelon-targaryen",
    speakerName: "Jacaelon Targaryen",
    chapterSlug: "the-weight-of-loyalty",
    chapterTitle: "Chapter III: The Weight of Loyalty",
  ...
  {
    text: "Stags are merely meals for dragons. (to Maela)",
    speakerId: "jacaelon-targaryen",
    speakerName: "Jacaelon Targaryen",
  ...
  {
    text: "You know what the problem with the Kingsguard is? They pass over fixers—real men like me—and hire prancing pretty boys who spend their mornings brushing their hair. (to Ser Alester)",
  ...
  {
    text: "Your body is [here]. The rest of you left this hall hours ago. (to Jace)",
  ...
  {
    text: "Next time, remember who it is you dare disappoint. (to Visenor)",
    speakerId: "baelenys-targaryen",
    speakerName: "Baelenys Targaryen",
    chapterSlug: "the-price-of-trust",
    chapterTitle: "Chapter II: The Price of Trust"
  ...
  {
    text: "I have never seen a man as spineless as you. (to Visenor)",
    speakerId: "jacaelon-targaryen",
    speakerName: "Jacaelon Targaryen",
    chapterSlug: "the-price-of-trust",
    chapterTitle: "Chapter II: The Price of Trust"
  ...
  {
    text: "I spent years believing I could solve everything if I simply thought long enough. I was wrong.",
    speakerId: "jacaelon-targaryen",
    speakerName: "Jacaelon Targaryen",
    chapterSlug: "the-weight-of-loyalty",
    chapterTitle: "Chapter III: The Weight of Loyalty"
  ...
  {
    text: "You will become heir to the Iron Throne. I did not ask whether you wanted it. (to Gaelor)",
    speakerId: "baelenys-targaryen",
    speakerName: "Baelenys Targaryen",
    chapterSlug: "the-weight-of-loyalty",
    chapterTitle: "Chapter III: The Weight of Loyalty"
  ...
  {
    text: "The people have suffered enough. They will not pay for a royal celebration.",
    speakerId: "jaery-targaryen",
    speakerName: "Queen Jaery Targaryen",
    chapterSlug: "the-weight-of-loyalty",
    chapterTitle: "Chapter III: The Weight of Loyalty"
  },
  {
    text: "I've fought men twice my size. They frightened me less. (to Naella, on the wedding day)",
    speakerId: "gaelor-targaryen",
    speakerName: "Gaelor Targaryen",
    chapterSlug: "the-weight-of-loyalty",
    chapterTitle: "Chapter III: The Weight of Loyalty"
  ...
  {
    text: "You should be king. Not Gaelor. You. (to Jace)",
    speakerId: "derrin-hightower",
    speakerName: "Derrin Hightower",
    chapterSlug: "the-weight-of-loyalty",
    chapterTitle: "Chapter III: The Weight of Loyalty"
  ...
  {
    text: "If that is the King’s will.",
    speakerId: "gaelor-targaryen",
    speakerName: "Gaelor Targaryen",
    chapterSlug: "the-weight-of-loyalty",
    chapterTitle: "Chapter III: The Weight of Loyalty"
  ...
  {
    text: "The only reason I am alive is King Baelenys.",
    speakerId: "ser-alester-dayne",
    speakerName: "Alester Dayne",
    chapterSlug: "the-weight-of-loyalty",
    chapterTitle: "Chapter III: The Weight of Loyalty"
  },
  {
    text: "Jace has no desire to rule. But he is a fucking prick.",
    speakerId: "gaelor-targaryen",
    speakerName: "Gaelor Targaryen",
    chapterSlug: "the-broken-knight",
    chapterTitle: "Chapter IV: The Broken Knight"
  ...
  {
    text: "A strike against the King does not go unpunished.",
    speakerId: "gaelor-targaryen",
    speakerName: "Gaelor Targaryen",
    chapterSlug: "fathers-and-their-sins",
    chapterTitle: "Chapter V: Fathers and Their Sins"
