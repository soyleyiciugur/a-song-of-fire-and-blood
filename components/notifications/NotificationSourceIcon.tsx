...
export default function NotificationSourceIcon({ source, size = 16 }: { source: NotificationSource; size?: number }) {
  ...
  if (source === "profile") return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true"><circle cx="12" cy="8" r="3.1" fill="currentColor" fillOpacity=".1" stroke="currentColor" strokeWidth="1.5"/><path d="M5.5 19c.7-3.8 3-5.7 6.5-5.7s5.8 1.9 6.5 5.7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><path d="M17.5 8.3h3M19 6.8v3" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/></svg>;
