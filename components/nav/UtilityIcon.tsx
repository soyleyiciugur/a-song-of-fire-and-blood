...
export default function UtilityIcon({ name, size = 20, className }: { name: UtilityIconName; size?: number; className?: string }) {
  ...
  return <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false">
    ...
    {name === "workbench" && <><path d="M5 7.5h14l-1.6 4.2H6.6L5 7.5Z" fill="currentColor" fillOpacity=".1" stroke="currentColor" strokeWidth="1.45" strokeLinejoin="round"/><path d="M8.5 11.7 7 18.5m8.5-6.8 1.5 6.8M5.5 18.5h13" stroke="currentColor" strokeWidth="1.45" strokeLinecap="round"/><path d="M9 4.5h6" stroke="currentColor" strokeWidth="1.45" strokeLinecap="round"/></>}
