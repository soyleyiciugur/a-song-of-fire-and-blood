...
export type UtilityIconName = "search" | "workbench" | "eye" | "cards" | "taverns" | "raven" | "notifications";
...
export default function UtilityIcon({ name, size = 20, className }: { name: UtilityIconName; size?: number; className?: string }) {
  ...
  return <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false">
    ...
    {name === "workbench" && <><path d="M14.2 3.7a5.1 5.1 0 0 0-5.8 6.6L3.7 15a2 2 0 0 0 0 2.8l2.5 2.5a2 2 0 0 0 2.8 0l4.7-4.7a5.1 5.1 0 0 0 6.6-5.8l-3.1 3.1-3.9-.8-.8-3.9 3.1-3.1c-.45-.18-.92-.31-1.4-.4Z" fill="currentColor" fillOpacity=".08" stroke="currentColor" strokeWidth="1.45" strokeLinecap="round" strokeLinejoin="round"/><path d="m5.9 16.1 2 2M8.1 14l2 2" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round"/></>}
