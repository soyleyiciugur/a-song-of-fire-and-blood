...
type Option={id:string;title:string;href:string;image?:string;portrait?:string;mediaSrc?:string;mediaType?:"image"|"video";chapterTitle?:string|null;context?:string|null};
