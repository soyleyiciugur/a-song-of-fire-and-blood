...
(async () => {
  ...
  try {
    for (const viewport of [{ width: 1440, height: 900 }, { width: 390, height: 844 }]) {
      ...
      const castThread = page.getByRole('region', { name: 'Flea Bottom comments' });
      ...
      const replyRoot = page.getByRole('region', { name: 'Flea Bottom comments' }).locator('ol').first().locator(':scope > li').first();
